 ...
 */
MapTo('nyl-aggregator/components/navigation')(NavigationV1Component, {isEmpty: NavigationV1IsEmptyFn});
MapTo('nyl-aggregator/components/separator')(SeparatorV1Component);

MapTo('nyl-aggregator/components/container')(ContainerV1Component, {isEmpty: ContainerIsEmptyFn});
MapTo('nyl-aggregator/components/experiencefragment')(ContainerV1Component, {isEmpty: ContainerIsEmptyFn});

MapTo('nyl-aggregator/components/download')(DownloadV1Component,{isEmpty: DownloadV1IsEmptyFn});
MapTo('nyl-aggregator/components/languagenavigation')(LanguageNavigationV1Component);
MapTo('nyl-aggregator/components/list')(ListV2Component, {isEmpty: ListV2IsEmptyFn});
MapTo('nyl-aggregator/components/breadcrumb')(BreadCrumbV2Component, {isEmpty: BreadCrumbV2IsEmptyFn});
MapTo('nyl-aggregator/components/button')(ButtonV1Component, {isEmpty: ButtonV1IsEmptyFn});
MapTo('nyl-aggregator/components/image')(ImageV2Component, {isEmpty: ImageV2IsEmptyFn});
MapTo('nyl-aggregator/components/title')(TitleV2Component, {isEmpty: TitleV2IsEmptyFn});

MapTo('nyl-aggregator/components/accordion')(AccordionV1Component);
MapTo('nyl-aggregator/components/tabs')(TabsV1Component);
...
LazyMapTo('nyl-aggregator/components/teaser')(TeaserV1Component);
...
LazyMapTo('nyl-aggregator/components/carousel')(CarouselV1Component);
...
LazyMapTo('nyl-aggregator/components/text')(LazyTextModule, TextEditConfig);